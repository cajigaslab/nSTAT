...
For the canonical textbook treatment of the math — including full derivations
of the time-rescaling theorem (§4.C.1), the PPAF as one-step Newton on the
variational free energy (§4.C.2), the PPHF (§4.C.3), and the PPLFP additive
boxed equations (§4.B.7.3) — see *Decoding the Brain*, Chapter 4 (Cajigas Lab
